            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to("/all-category-product")}}">Liet ke danh muc</a></li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to("/all-brand-product")}}">Liet ke </a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to("/add-discount")}}">Thêm chương trình khuyến mãi</a></li>
                        <li><a href="{{URL::to("/all-discount")}}">Thêm sản phẩm vào khuyến</a></li>
